...
export default function HeroPackage({ heroSections }: HeroSliderProps) {
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/70">
              <div className="container mx-auto flex h-full flex-col items-center justify-center px-4 text-center text-white">
                <h5 className="mb-4 text-xl font-bold tracking-tight">
                  {hs.title}
                </h5>
                <p className="mb-8 font-bold ">Our All Packages</p>
