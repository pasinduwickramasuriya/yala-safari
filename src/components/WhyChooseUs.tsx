      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="p-6  rounded-xl  hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
            ...
            <h3 className="text-2xl font-bold text-card-foreground mb-3">Expert Guides</h3>
          ...
          <div className="p-6  rounded-xl  hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
            ...
            <h3 className="text-2xl font-bold text-card-foreground mb-3">Comfortable Jeeps</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="p-6  rounded-xl  hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 ">
            ...
            <h3 className="text-2xl font-bold text-card-foreground mb-3">Best Rates</h3>
            <p className="text-muted-foreground leading-relaxed">
