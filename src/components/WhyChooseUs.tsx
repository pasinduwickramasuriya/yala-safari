  ...
  return (
    <section className="bg-black py-20">
      <div className="container mx-auto px-4 md:px-0 text-center">
        <h2 className="text-4xl md:text-2xl font-extrabold text-white mb-12 tracking-tight animate-fadeIn">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="p-6 bg-gray-900 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Expert Guides</h3>
          ...
          <div className="p-6 bg-gray-900 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Comfortable Jeeps</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="p-6 bg-gray-900 rounded-xl shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Best Rates</h3>
            <p className="text-gray-300 leading-relaxed">
