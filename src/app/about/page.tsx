...
async function fetchData() {
  try {
    ...
    return { packages: [], heroSections: [] }; // Fallback for error handling
  }
}
    ...
    <>
      ...
      <main className="bg-background text-foreground min-h-screen">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="text-center">
                <h2 className="text-3xl md:text-2xl font-bold text-green-600 dark:text-green-500 mb-6">
                  Yala National Park
                </h2>
                <p className="text-base  text-muted-foreground leading-relaxed mb-4">
                  Nestled in the southeast of Sri Lanka, Yala National Park is a biodiversity hotspot renowned for its rich wildlife and stunning landscapes. Spanning over 979 square kilometers, it's home to one of the highest leopard densities in the world, alongside elephants, sloth bears, crocodiles, and over 200 species of birds. The park's diverse ecosystemsranging from dense jungles to coastal lagoons offer a breathtaking backdrop for safari adventures.
                </p>
              ...
              <div className="relative h-64 md:h-96 rounded-xl overflow-hidden shadow-lg border border-border/50">
                <Image
        ...
        <section className="bg-background text-foreground py-16">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl md:text-2xl font-bold text-center text-green-500 mb-12">
              Our Services
            </h2>
